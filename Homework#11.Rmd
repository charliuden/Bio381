...
For today's assignment I will be using data on stage transitions of centaurea (knapweed). Each row is a population of centaurea. Eventually, I will use this data to build population matrices, but right now I am just going to use ggplot to plot to peek at the data. 
...
To start, I found a significant relationshipt between species and survival of adult flowering plants (sf):
...
So, let's plot this relationship: population loaction (Location) and survival of adult flowering plants (sf).
...
Another variable that may be related to survival is location. This also shows a significant relationship with survival. Again, I am going make a box plot so we can "see" it. 
...
From plots 4 and 5, I would predict that 
